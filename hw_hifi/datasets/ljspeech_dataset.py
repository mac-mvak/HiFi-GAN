...
class LJspeechDataset(Dataset):
    def __init__(self, config_parser: ConfigParser
                 , data_dir=None, crop_len=None, *args, **kwargs):
    ...
    def __getitem__(self, ind):
        ...
        if self.crop_len is not None:
            max_audio_start = audio_wave.shape[-1] - self.crop_len
            start_pose = random.randint(0, max_audio_start)
            audio_wave = audio_wave[..., start_pose:start_pose+self.crop_len]
        return {
            "audio": audio_wave,
