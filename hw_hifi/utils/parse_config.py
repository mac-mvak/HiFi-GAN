...
from hw_hifi import text_encoder as text_encoder_module
from hw_hifi.base.base_text_encoder import BaseTextEncoder
from hw_hifi.logger import setup_logging
from hw_hifi.text_encoder import CTCCharTextEncoder
...
class ConfigParser:
    ...
    def get_default_configs(cls):
        config_path = ROOT_PATH / "hw_hifi" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))

    @classmethod
    def get_test_configs(cls):
        config_path = ROOT_PATH / "hw_hifi" / "tests" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))
